...
class Model extends CI_Model {
	...
	{
		return $this->db->select($select)->from($tableName)->where($where)->limit($limit)->get()->result_array();
	}
	...
	{
		return $this->db->select($select)->from($tableName)->order_by($orderValue,$orderBy)->get()->result_array();
	}
