...
<body>
                    ...
                    <div class="container text-center">
                        <div class="row">
                            <div class="inner-conraimer-details">
                                 <div class="col-md-12">
                                     <h1 class="text-uppercase">Diploma Associate Programme</h1>
                                </div>
                           </div>
                      </div>
                   </div>
                              ...
                              <div class="col-md-12">
                                  <div class="ulockd-icd-layer">
                                        <ul class="list-inline ulockd-icd-sub-menu">
                                            ...
                                            <li><a href="#"> ||</a></li>
                                            <li> <a href="course-detail.php"> Diploma Associate Programme </a> </li>
                                        </ul>
                                  </div>
                              </div>
                        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 text-center  ">
          <div class="title">
              <h2>Diploma Associate <span>Programme</span></h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-8 col-lg-9">
          <div class="row">
            <div class="col-xxs-12 col-xs-6 col-sm-6 col-lg-4 course-box-main">
              <div class="course-box">
                ...
                <div class="cb-details">
                  ...
                  <h4>Diploma Associate Programme in Mechanical Engineering</h4>
            ...
            <div class="col-xxs-12 col-xs-6 col-sm-6 col-lg-4 course-box-main">
              <div class="course-box">
                ...
                <div class="cb-details">
                  ...
                  <h4>Diploma Associate Programme in Electrical Engineering</h4>
                </div>
              </div>
            </div>
            
            <div class="col-xxs-12 col-xs-6 col-sm-6 col-lg-4 course-box-main">
              <a href="course-details.php"><div class="course-box">
                <div class="cb-thumb">
            
                  <img class="img-responsive img-whp" src="images/service/6.jpg" alt="6.jpg">
                </div>
                <div class="cb-details">
            
                  
                  <h4>Diploma Associate Programme in Civil Engineering</h4>
  ...
  <div class="form-wrapper" id="fcontact-form">
    <div class="enquiry-title">Course Search</div>
                                                         ...
                                                         <select id="study_level" class="study_level form-control ulockd-bgthm" name="study_level">
                                                            ...
                                                            <li>
                                                               ...
                                                               <li>
                                                                ...
                                                                <div class="form-group">        
    <button type="submit" class="btn skip "style="font-size: 27px;">GO</button>       
    </div>   
                                                       </form>
