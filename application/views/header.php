...
<nav id="navbar-s" class="navbar navbar-expand-md " >
  <a class="navbar-brand logo-top" href="index.php" id="logo"><img src="<?=base_url();?>assets/images/iapl/logo.png" width="120"></a>
...
<div id="mySidenav" class="sidenav">
      <a href="index.php" class="closebtn" onclick="closeNav()">&times;</a>
                  <a href="index.php"><img src="<?=base_url();?>assets/images/iapl/logo.png" width="120"></a>
