                          ...
                          <div class="col-lg-8">
                                <div class="tabcontent">
                                      <h5> Current Opening</h5>
                                            <h3>Graphic Designer – Layout Artist</h3>
                                                <ul>
                                                    <li><i class="arrow_carrot-2right text-thm2"></i> Required graphic designer in creating branding, sales and marketing collateral as per defined guidelines.</li>
                                                    <li><i class="arrow_carrot-2right text-thm2"></i> Liaise with branding team to discuss their requirements - and help to resolve any issues related to the work produced.</li>
                                                    <li><i class="arrow_carrot-2right text-thm2"></i> Ensure all artwork produced meets the need, requirements and brand values.</li>
                                                    <li><i class="arrow_carrot-2right text-thm2"></i> Creation of design work, including packaging, display banners, labels, hoardings and other art works.</li>
                                                    <li><i class="arrow_carrot-2right text-thm2"></i> Help to produce internal sales and marketing materials.</li>
                                                </ul>
                                         <table class="table">
                                              <tbody>
                                                    <tr>
                                             ...
                                             <h4>Graphic Design Competencies:</h4>
                                                <ul>
                                                     <li><i class="arrow_carrot-2right text-thm2"></i> Photoshop (Preferred)</li>
                                                     <li><i class="arrow_carrot-2right text-thm2"></i> Indesign (Preferred)</li>
                                                      <li><i class="arrow_carrot-2right text-thm2"></i> Illustrator (Preferred)</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Corel Draw (Preferred)</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Graphic Designing (Preferred) </li>
<li><i class="arrow_carrot-2right text-thm2"></i> Creative Designing (Preferred) </li>
<li><i class="arrow_carrot-2right text-thm2"></i> Illustration (Preferred)</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Print Media (Preferred) </li>

<li><i class="arrow_carrot-2right text-thm2"></i> Flash (Preferred) </li>
        </ul>
          <h4>Job Duties:</h4>
          <ul>
          <li><i class="arrow_carrot-2right text-thm2"></i> Draft mockups of website designs, brochures, iconography, and any other marketing materials required</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Collaborate with marketing teams and management to discuss which mockups are effective, and use their feedback to develop final drafts</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Revise the work of previous designers to create a unified aesthetic for our brand materials</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Work on multiple projects at once, and consistently meet draft deadlines</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Communicate frequently with clients to update them on the progress of the project and to answer any questions they might have
</li>
<li><i class="arrow_carrot-2right text-thm2"></i> Other duties as requested
</li>
        </ul>
    </div>
  </div>
