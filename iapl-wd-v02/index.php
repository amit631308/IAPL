   ...
   <body>
       ...
       <div class="wrapper">
           ...
           <header>
                <nav id="navbar-s" class="navbar navbar-expand-md " >
                      <a class="navbar-brand logo-top" href="index.php" id="logo"><img src="images/iapl/logo.png" width="120"></a>
                          <div class="collapse navbar-collapse" id="collapsibleNavbar">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                     ...
                                     <li class="nav-item ">
                                          <a class="nav-link"  href="programme.php">Programmes <!-- <i class="fa fa-angle-down "style="font-size: 17px;font-weight: bold;"></i> --> </a>
                                          <div class="sub-menu">
              ...
              <div id="mySidenav" class="sidenav">
                    ...
                    <a href="#"><img src="images/iapl/logo.png" width="120"></a>
             ...
             <div id="main"> 
                   <span class="mob-menu"style="font-size:30px;cursor:pointer;float:right;margin-right:25px;" onclick="openNav()">&#9776; 
                         <span class="mob-logo"><img src="images/iapl/logo.png" width="70"></span>
                   </span>
                   <button class="navbar-toggler search-icon" type="button" data-toggle="collapse" data-target="#collapsibleNavbar"><img src="images/search.png">
                    </button>
                      <div class="collapse navbar-collapse" id="collapsibleNavbar">
       ...
       <!-- Home Design -->
          <div class="ulockd-home-slider">
               <div class="container-fluid">
                    <div class="row">
                        <div class="pogoSlider" id="js-main-slider">
                             <div class="pogoSlider-slide" data-transition="zipReveal" data-duration="1500" style="background-image:url(images/home/h1.jpg);">
            ...
            <div class="pogoSlider-slide" data-transition="blocksReveal" data-duration="1500" style="background-image:url(images/iapl/Home_page1.jpg);">
              <div class="lbox-caption">
                <div class="lbox-details">
            ...
            <div class="pogoSlider-slide" data-transition="shrinkReveal" data-duration="2000" style="background-image:url(images/iapl/Home_page2.jpg);">
              <div class="lbox-caption">
                <div class="lbox-details">
              ...
              <div class="project-heading">
                  ...
                  <div class="row" style="margin-right: 0px!important;">
                            ...
                            <div class="row feature-row">
                                  <div class="col-md-6">
                                        <div class="projectImg">
                                              <img src="images/iapl/ner/hybrid_online.png" alt="">
                                        ...
                                        <div class="col-md-6">
                                              <div class="projectImg">
                                                    <img src="images/iapl/ner/acc.png" alt="">
                                                          <div class="service-overlay">
                      ...
                      <div class="col-md-4">
                                  	...
                                  	<img src="images/portfolio6.jpg" alt="" height="645">
    	                                   <div class="caption">
        	                                       <h3> Why IAPL Institute</h3>
                                                    <h5>We deal with the of professional IT Services</h5>
      		                                        <ul>
                                                        ...
                                                        <li><img src="images/iapl/ner/online-support.png" width="60" style="padding-right:10px;"> 24*7 Online support</li>
                          ...
                          <div id="sliderblog"class="owl-carousel owl-theme">
                                <div class="single-item">
                                      <div class="single-item-image overlay-effect"> 
                                            <a href="#"><img src="images/about/Mechanical.png" alt=""></a> 
                                      </div>
                                    ...
                                    <div class="single-item">
                                          <div class="single-item-image overlay-effect"> 
                                                <a href="#"><img src="images/about/civil.png" alt=""></a>
                                           </div>
                                              <div class="single-item-text">
                                         ...
                                         <div class="single-item">
                                              <div class="single-item-image overlay-effect"> <a href="#">
                                                    <img src="images/about/HSE.png" alt=""></a> 
                                              </div>
                                                <div class="single-item-text">
                                        ...
                                        <div class="single-item">
                                              <div class="single-item-image overlay-effect">
                                                 <a href="#"><img src="images/about/business.png" alt=""></a>
                                              </div>
                                              <div class="single-item-text">
                                     ...
                                     <div class="single-item">
                                            <div class="single-item-image overlay-effect"> 
                                                 <a href="#"><img src="images/about/project.png" alt=""></a>
                                           </div>
                                           <div class="single-item-text">
                  ...
                  <div class="about-wrapper-inner">
                        <div class="container">
                                  ...
                                  <div class="aboutus-box">
                                        <div class="col-sm-4 aboutus-box-image"><img src="images/iapl/ngo.png"     class="img-responsive" alt="">
                                        </div>
                      ...
                      <div style="background-image:url(images/iapl/home-1.jpg);background-size: cover;background-repeat: no-repeat;" class="about-bg  bg-image">
                      </div>
          </div>
</section>
