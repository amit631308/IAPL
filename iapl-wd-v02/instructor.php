                                                      ...
                                                      <form class="row">
                                                          <div class="col-md-12">
                                                              <div class="form-group">
                                                                  <input type="text" class="form-control" id="exampleInputNamexa" placeholder="Full Name">
                                                              </div>
                                                          </div>
                                                          <div class="col-md-6">
                                                              <div class="form-group">
                                                          ...
                                                          <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12">
                                                               <div class="form-group">
                                                                  ...
                                                                  <ul  class="radio-list">
                                                                    <li>
    <input type="radio" name="addLive" value="petaling" onclick="showText(1)"> <label for="Informal">Informal</label></li>
    <li>
    <input type="radio" name="addLive" value="kl" onclick="showText(2)"> <label for="female">Professional</label></li>
    <li>
    <input type="radio" name="addLive" value="shahalam" onclick="showText(3)"> <label for="other">Online</label></li>
    <li>
    <input type="radio" name="addLive" value="othersHide" id="showAddLiveOthers" onclick="showText(4)">          <label for="other">Other</label></li>
    <input type="text" name ="addLiveOthers" id="addLiveOthers">
                                                          ...
                                                          <div class="col-md-12">
                                                              <div class="form-group">
                                                                  <label for="q2">Q. What courses could you offer to teach?</label>
                                                                   <textarea name="Massage" rows="1" placeholder="" class="form-control bg-white"></textarea>
                                                              </div>
                                                          </div>
                                                          <div class="col-md-12">
                                                              <div class="form-group">
                                                          ...
                                                          <div class="col-md-12">
                                                              <div class="form-group    ">
                                                                 ...
                                                                 <ul  class="radio-list">
                                                                    <li>
                                                                       <input type="radio" name="addLive" value="">
           ...
           <div class="container"> 
                <div class="row">
                     <div class="col-md-12 text-center " style="margin-top: 50px;">
                       ...
                       <div class="col-md-4 text-center skill-box">
                             <div class="skill-icon ">
                                   <img src="images/iapl/ner/like.png">
                              </div>
                            ...
                            <div class="col-md-4 text-center skill-box">
                                  <div class="skill-icon ">
                                      <img src="images/iapl/ner/video-tutorial.png">
                                  </div>
                                  <div class="skill-content ">
                            ...
                            <div class="col-md-4 text-center skill-box">
                                  <div class="skill-icon  ">
                                      <img src="images/iapl/ner/profit.png">
                                  </div>
                                  <div class="skill-content ">
                                      <h4>Earn Money</h4>
                  ...
                  <li><img src="images/testimonial/1.jpg" class="rounded-circle" ></li>
                  ...
                  <li class="team-memb"><span>- Michal Marek</span> <h6>Mechnical Engineer</h6></li>
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div class="facility-member">
                                                                 <ul class="list-inline course-feature">
                  <li><img src="images/testimonial/2.jpg" class="rounded-circle" ></li>
                  ...
                  <li class="team-memb"><span>- Michal Marek</span> <h6>Mechnical Engineer</h6></li>
                                ...
                                <div class="col-md-4">
                                        <div class="facility" style="border-top:6px solid #1baa4b;">
                                         ...
                                         <div class="facility-member">
                                          <ul class="list-inline course-feature">
                  <li><img src="images/testimonial/3.jpg" class="rounded-circle" ></li>
