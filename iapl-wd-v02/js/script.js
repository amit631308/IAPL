...
function scrollFunction() {
  if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
    document.getElementById("navbar-s").style.padding = "0px 30px";
    document.getElementById("navbar-s").style.backgroundColor = "#fff";
    document.getElementById("navbar-s").style.width = "100%";
    document.getElementById("navbar-s").style.position = "fixed"; 
    document.getElementById("navbar-s").style.top = "0%";
    document.getElementById("navbar-s").style.height = "90px";
    document.getElementById("navbar-s").style.transition = "0.3s";
   document.getElementById("main").style.transition = "0.3s";
    document.getElementById("main").style.position = "fixed";
    document.getElementById("main").style.width = "100%"; 
    document.getElementById("main").style.top = "0%";
    document.getElementById("main").style.backgroundColor = "#fff";
    document.getElementById("main").style.boxShadow = "0 0 15px 0 rgba(0, 0, 0, 0.15)";
document.getElementById("logo").style.transition = "0.3s";
    ...
    document.getElementById("navbar-s").style.padding = "0px 20px";
    document.getElementById("navbar-s").style.backgroundColor = "rgb(255 255 255 / 25%)";
    document.getElementById("navbar-s").style.width = "100%";    
    document.getElementById("navbar-s").style.position = "relative";
    document.getElementById("navbar-s").style.top = "7%";
    document.getElementById("navbar-s").style.height = "72px";
    document.getElementById("navbar-s").style.transition = "0.3s";
   document.getElementById("main").style.transition = "0.3s";
    document.getElementById("main").style.position = "relative";
    document.getElementById("main").style.width = "100%";
    document.getElementById("main").style.top = "11%";
    document.getElementById("main").style.backgroundColor = "rgb(255 255 255 / 25%)";
    document.getElementById("main").style.boxShadow = "0 0 15px 0 rgba(0, 0, 0, 0.15)";
        
    document.getElementById("logo").style.top = "-48px";
